...
Deno.bench('Distribution Bench - c2p - jstat-esm', () => { c2p((Math.random() + 1) * 10, (Math.random() + 1) * 10) })
Deno.bench('Distribution Bench - p2c - @psych/lib', () => { pl.p2c(Math.random(), (Math.random() + 1) * 10) })
Deno.bench('Distribution Bench - p2c - jstat-esm', () => { p2c(Math.random(), (Math.random() + 1) * 10) })
