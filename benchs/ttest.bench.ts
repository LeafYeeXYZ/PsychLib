...
Deno.bench('TTest Bench - OneSampleTTest - @stdlib/stats-ttest', () => { ttest(x()) })
Deno.bench('TTest Bench - TwoSampleTTest - @psych/lib', () => { new pl.TwoSampleTTest(x(), y()) })
Deno.bench('TTest Bench - TwoSampleTTest - @stdlib/stats-ttest2', () => { ttest2(x(), y()) })
Deno.bench('TTest Bench - PeerSampleTTest - @psych/lib', () => { new pl.PeerSampleTTest(x(), y()) })
Deno.bench('TTest Bench - PeerSampleTTest - @stdlib/stats-ttest', () => { ttest(x(), y()) })
