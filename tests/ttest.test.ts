...
Deno.test('TTest Test', () => {
  ...
  const ttest_py = JSON.parse(py.runPython(`
    import numpy as np
  ...
  const ttestp_py = JSON.parse(py.runPython(`
    import numpy as np
  ...
  const ttest2_py = JSON.parse(py.runPython(`
    import numpy as np
  ...
  const ttestw_py = JSON.parse(py.runPython(`
    import numpy as np
    from scipy.stats import ttest_ind
    import json
    x = ${JSON.stringify(x)}
